...
def main() -> int:
    ...
    # Create your queues
    input_queue = queue_proxy_wrapper.QueueProxyWrapper(mp_manager, IN_QUEUE_MAX_SIZE)
    output_queue = queue_proxy_wrapper.QueueProxyWrapper(mp_manager, OUT_QUEUE_MAX_SIZE)
